...
export default function Goals() {
    const metrics = [
        { number: 1, title: 'Create a project', description: 'Teams should be able to create and manage their own team dashboard and project, unique to them and their needs.' },
    ...
    return (
        <div className="mt-16 mb-6 rounded-lg bg-[#323232] p-4">
            ...
            <h1 className="text-[#949494] text-sm">Our Team's Goal</h1>
