    ...
    return (
        <div className="mb-10">
            ...
            <p className={"text-sm mt-3"}>
                ...
                Though each project is unique, most relate to each other in their methods and structures to collect data.
            ...
            <p className={"text-sm mt-3"}>
                ...
                With multiple platforms and applications tracking this data, it becomes easy to be disorganized and inefficient, while putting together a comprehensive
                solution without this overhead cost.
            </p>
        </div>
    )
}
