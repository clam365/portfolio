        ...
        <div>
            ...
            <div className={"mt-6"}>
                ...
                <p className={"text-sm mt-1"}>
                    ...
                    This was the first time I got my feet wet in developing a full-stack app through WPI's project-based learning in the Agile Scrum methodology.
                    {/* eslint-disable-next-line react/no-unescaped-entities */}
                    &nbsp;It opened many doors for me, and it blossomed my passion into being a frontend developer, focusing intensively on UI's impact. If I could do this course
