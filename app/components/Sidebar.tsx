            ...
            <aside className="w-64 h-full p-12 border-r border-neutral-200 lg:block hidden fixed ">
                <nav>
                    <div>
                        ...
                        <Link href={"/resume.pdf"} target={"_blank"} rel={"opener referrer"}>
                            <h1 className="font-semibold text-xl mb-6 hover:text-gray-400 transform hover:translate-x-1 transition">Resume</h1>
                        </Link>
